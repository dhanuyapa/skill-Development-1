...
else if(isset($_POST['pj2']))
{
    $valueToSearch = 'ASCENTI';
    $position = $_POST['position'];	
}

else if(isset($_POST['pj3']))
{
    $valueToSearch = 'ANCELL';
    $position = $_POST['position'];	
}

else if(isset($_POST['pj4']))
{
    $valueToSearch = 'XTZ';
    $position = $_POST['position'];	
}
else if(isset($_POST['pj5']))
{
    $valueToSearch = 'ZEST';
    $position = $_POST['position'];	
}
else if(isset($_POST['pj6']))
{
    $valueToSearch = 'PWC';
    $position = $_POST['position'];	
}
else if(isset($_POST['pj7']))
{
    $valueToSearch = 'GJOBS';
    $position = $_POST['position'];	
}
else if(isset($_POST['pj8']))
{
    $valueToSearch = 'MATIFIC';
    $position = $_POST['position'];	
}
...
if($valueToSearch != null && $position != null){
	...
	$query = "SELECT * FROM `pj` where companyName='".$valueToSearch."' AND position = '".$position."'";
    $search_result = filterTable($query, $con);	
}
else if($valueToSearch == null && $position != null){
	$query = "SELECT * FROM `pj` where position = '".$position."'";
    $search_result = filterTable($query, $con);
}
else if($valueToSearch != null && $position == null){
	
	$query = "SELECT * FROM `pj` where companyName='".$valueToSearch."'";
    $search_result = filterTable($query, $con);	
}
else{
...
function showSlides(n) {
  ...
  dots[slideIndex-1].className += " active";
		...
		<div>
        <center> <button name = "pj1"><img src="../images/pj1.jfif" class="l1"></button>
         <button name = "pj2"><img src="../images/pj2.jfif" class="l2"></button>
         <button name = "pj3"><img src="../images/pj3.jfif" class="l3"></button>
         <button name = "pj4"><img src="../images/pj4.jfif" class="l4"></button></center><br><br><br>
 
         <center> <button name = "pj5"><img src="../images/pj5.jfif" class="l1"></button>
         <button name = "pj6"><img src="../images/pj6.jfif" class="l2"></button>
         <button name = "pj7"><img src="../images/pj7.jfif" class="l3"></button>
         <button name = "pj8"><img src="../images/pj8.png" class="l4"></button></center><br><br><br>
		</div>
